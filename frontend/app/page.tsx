    ...
    <main className="min-h-screen bg-stone-50 font-sans selection:bg-amber-100">
      ...
      <section id="analysis" className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-stone-900 text-balance">
      ...
      {analysisComplete && (
        <>
          <section className="container mx-auto px-4 py-16 md:py-24 animate-in slide-in-from-bottom-10 duration-700">
            <div className="max-w-4xl mx-auto">
              <Card className="bg-white border-stone-200 shadow-2xl overflow-hidden">
                ...
                <CardContent className="space-y-12 pb-16">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-10 p-10 bg-stone-50/50 rounded-2xl border border-stone-100">
                    ...
                    <div className="text-center md:text-left space-y-2">
                      <p className="text-caption">감지된 톤</p>
                  ...
                  <div className="space-y-4 px-4">
                    <p className="text-caption text-center">Monk 스케일에서의 위치</p>
              ...
              <Card className="bg-white border-stone-200 shadow-lg overflow-hidden">
                <CardHeader className="bg-stone-50/50 border-b border-stone-100 pb-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-caption text-violet-600">Fashion & Palette</span>
                  </div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {recommendations.best_colors?.map((color, i) => (
                          <div key={i} className="group flex flex-col gap-2">
                            ...
                            <span className="text-xs font-medium text-stone-600 text-center whitespace-nowrap overflow-hidden text-ellipsis w-full">{color.name}</span>
                          </div>
                      ...
                      <div className="flex flex-wrap gap-4">
                         {recommendations.worst_colors?.map((color, i) => (
                           <div key={i} className="flex flex-col items-center gap-2">
                             ...
                             <span className="text-xs font-medium text-stone-500 text-center whitespace-nowrap overflow-hidden text-ellipsis max-w-[80px]">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <Card className="bg-white border-stone-100 shadow-md hover:shadow-xl transition-all duration-300 group h-full flex flex-col">
                  <CardHeader className="pb-4">
                    ...
                    <CardDescription className="text-caption text-stone-500">{recommendations.skincare_focus}</CardDescription>
                  </CardHeader>
                    ...
                    <div className="space-y-3">
                      {recommendations.skincare_products?.map((product, i) => {
                        ...
                        <div key={i} className={`flex flex-col rounded-xl border overflow-hidden transition-all duration-300 ${isActive ? 'bg-amber-100 border-amber-300 ring-2 ring-amber-200' : 'bg-amber-50/50 border-amber-100'}`}>
                            ...
                            >
                              <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-amber-400 shrink-0 group-hover/item:scale-125 transition-transform" />
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center justify-between gap-3">
                                  <p className={`text-sm font-bold ${isActive ? 'text-amber-800' : 'text-stone-800'} underline decoration-amber-200/50 underline-offset-2 whitespace-nowrap overflow-hidden text-ellipsis flex-1 min-w-0`}>
                                    {itemName}
                                  </p>
                                  <div className="flex items-center gap-2 shrink-0">
                                    {typeof product !== 'string' && product.desc && (
                                      <span className={`px-2 py-0.5 rounded-md text-[10px] font-bold whitespace-nowrap ${
                                        isActive ? 'bg-amber-200 text-amber-900' : 'bg-blue-50 text-blue-700'
                                      }`}>
                                        {product.desc}
                                      </span>
                                    )}
                ...
                <Card className="bg-white border-stone-100 shadow-md hover:shadow-xl transition-all duration-300 group h-full flex flex-col">
                  <CardHeader className="pb-4">
                    ...
                    <CardDescription className="text-caption text-stone-500">{recommendations.foundation_shade}</CardDescription>
                  </CardHeader>
                  <CardContent className="flex-1">
                    <div className="space-y-3">
                      {recommendations.foundation_products?.map((product, i) => {
                        ...
                        <div key={i} className={`flex flex-col rounded-xl border overflow-hidden transition-all duration-300 ${isActive ? 'bg-rose-100 border-rose-300 ring-2 ring-rose-200' : 'bg-rose-50/50 border-rose-100'}`}>
                            ...
                            >
                              <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-rose-400 shrink-0 group-hover/item:scale-125 transition-transform" />
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center justify-between gap-3">
                                  {/* 제품명 영역 */}
                                  <p className={`text-sm font-bold ${isActive ? 'text-rose-800' : 'text-stone-800'} underline decoration-rose-200/50 underline-offset-2 whitespace-nowrap shrink-0`}>
                                    {itemName}
                                  </p>
                                  {/* 특징 배지 영역 */}
                                  <div className="flex items-center gap-2 flex-1 min-w-0 justify-start overflow-hidden">
                                    {typeof product !== 'string' && product.desc && (
                                      <span className={`px-2 py-0.5 rounded-md text-[10px] font-bold truncate border text-left block min-w-0 max-w-[100px] md:max-w-[150px] ${
                                        isActive ? 'bg-rose-200 text-rose-900 border-rose-300' : 'bg-blue-50 text-blue-700 border-blue-100'
                                      }`}>
                                        {product.desc}
                                      </span>
                                    )}
                                    <Search className={`w-3 h-3 text-rose-500 shrink-0 transition-opacity ${isActive ? 'opacity-100' : 'opacity-0 group-hover/item:opacity-100'}`} />
                                  </div>
                                </div>
                              </div>
                            </div>
